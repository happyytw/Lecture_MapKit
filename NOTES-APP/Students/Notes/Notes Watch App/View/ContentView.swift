...
struct ContentView: View {
    ...
    @State private var notes: [Note] = [Note]() // 빈 배열
...
//        dump(notes)
        ...
        do {
            // 1. Convert the notes array to data using JSONEcoder
    ...
    func load() {
        DispatchQueue.main.async {
            do {
                ...
                let url = getDocumentDirectory().appending(components: "notes")
                
                // 2. Create a new property for teh data
